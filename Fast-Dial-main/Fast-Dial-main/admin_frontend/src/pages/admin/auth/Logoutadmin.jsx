...
import { adminLogout } from '../../../saga/features/admin/adminSlice'; 

const Logoutadmin = ({ onConfirm, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-[9%] pt-[30px] pb-[3%] px-[5%] rounded-2xl shadow-lg text-center">
        <img src={Logoutimg} alt="logoutimage" className="ml-[140px] mb-[50px]"/>
        <h2 className="text-xl font-semibold mb-9 pb-[5%]">Are you sure do you want to logout?</h2>
