...
function* getCustomerServiceDetailsSaga() {
  try {
    console.log("getCustomerServiceDetailsSaga: Calling API");
    const response = yield call(getCustomerServiceDetailsAPI);
    console.log("API response:", response);
    const customerServiceDetails = Array.isArray(response.data) ? response.data : [];
    yield put(getCustomerServiceDetailsSuccess(customerServiceDetails));
  } catch (error) {
    console.error("getCustomerServiceDetailsSaga error:", error.message);
